    ...
    return (
        <PurpleBackground>
            <main className={styles.mainQuestions}>
                <div className={styles.headerQuestions}><ArrowBackButton />
                    <Menu /></div>
                    ...
                    <div className={styles.mainCont2}>
                        ...
                        <div className={styles.classification}>
                            <div className={styles.classificationCont}>
                                ...
                                <Link href={result.correctAnswers === questions.length ? '/modulos/trilha-demo' :
                                    '/modulos/trilha-demo/fase1/aurora-explica'}>
